...
class _HomeState extends State<Home> {
  ...
  title() {
    return AppBar(
      title: Text("Conversor de Moedas (Real, Dólar e Euro)",
  ...
  body() {
    return SingleChildScrollView(
        child: Column(
          children: <Widget>[
            padding(
                row(padding(text('Valor:', 30, Colors.blue), 30, 0, 0, 0),
                    padding(container(textfield(value), 60, 200), 10, 0, 0, 0)), 0, 20, 0, 10),
            Row(children: <Widget>[
              padding(text('De:', 30, Colors.blue), 30, 0, 0, 0),
              padding(dropdown_from(), 10, 0, 0, 0),
              padding(text('Para:', 30, Colors.blue), 40, 0, 0, 0),
